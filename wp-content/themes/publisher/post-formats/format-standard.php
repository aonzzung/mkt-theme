...
<div <?php post_class( 'block-standard' ); ?>>
	<?php if ( '' != get_the_post_thumbnail() ) { ?>
		<?php if( is_single() ) { ?>
			<a class="block-thumb" href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'publisher' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_post_thumbnail( 'post-image' ); ?></a>
		<?php } else { ?>
