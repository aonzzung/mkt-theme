...
function publisher_customizer_register( $wp_customize ) {
	...
	//Slideshare
	$wp_customize->add_setting( 'publisher_customizer_icon_slideshare', array(
		'default' 		=> '',
		'type' 			=> 'option'
	) );

	$wp_customize->add_control( 'publisher_customizer_icon_slideshare', array(
		'label' 		=> __( 'Slideshare URL', 'publisher' ),
		'section' 		=> 'publisher_customizer_basic',
		'settings' 		=> 'publisher_customizer_icon_slideshare',
		'type' 			=> 'text',
		'priority' 		=> 25
	) );
