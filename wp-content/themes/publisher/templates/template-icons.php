			...
			<div class="header-search">
				<ul class="toggle-icons">
					<?php if ( get_option( 'publisher_customizer_icon_facebook' ) ||
						get_option( 'publisher_customizer_icon_twitter' ) ||
						get_option( 'publisher_customizer_icon_youtube' ) ||
						get_option( 'publisher_customizer_icon_linkedin' ) ||
						get_option( 'publisher_customizer_icon_slideshare' ) ||
							...
							<div class="icons">
								<div class="icons-widget">
									<div class="icon-links">
                                        ...
                                        <?php if ( get_option( 'publisher_customizer_icon_Slideshare' ) ) { ?>
											<a href="<?php echo esc_url( get_option( 'publisher_customizer_icon_Slideshare' ) ); ?>" class="slideshare-icon" title="<?php esc_attr_e( __( 'Slideshare', 'publisher') ); ?>"><i class="fa fa-slideshare"></i></a>
										<?php } ?>
